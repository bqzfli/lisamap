...
/**
* @ClassName: TouchPositionRotatedFromMap
* @Description: Transport position in the map, pressed on, to rectangle and show by a point 
* @Version: V1.0.0.0
* @author lisa
* @date 2017年1月26日 下午1:45:14
***********************************
* @editor lisa 
* @data 2017年1月26日 下午1:45:14
* @todo TODO
*/
public class TouchPositionRotatedFromMap  extends BaseTool {
	...
	public TouchPositionRotatedFromMap() {
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if(mListener!=null){
				mListener.doEvent(pointOnTouch);
			}
			return true;
		}
		return false;
