...
public class DrawToolEnableManager {
	 ...
	 */
	public void addListener(DrawToolEnableListener listener) {
		if (listeners == null) {
	 ...
	 * @param ElementListener 
	 */
	public void removeListener(DrawToolEnableListener listener) {
		if (listeners == null)
			return;
	...
	private void notifyListeners(boolean isEnable) throws IOException {
		...
		while (iter.hasNext()) {
			DrawToolEnableListener listener = (DrawToolEnableListener) iter.next();
