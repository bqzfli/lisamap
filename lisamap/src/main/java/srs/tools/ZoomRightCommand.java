...
public class ZoomRightCommand extends BaseCommand{
	...
	public void onClick(View v) {
		if(mBuddyControl.getActiveView().FocusMap()!=null){
			...
			IEnvelope envelope = new Envelope(centerPoint.X() - width*7/10,
					centerPoint.Y() - height/2, centerPoint.X() + width*3/10, 
